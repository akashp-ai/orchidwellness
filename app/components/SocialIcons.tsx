// Brand-accurate social icons — using official SVG paths and colours.
// All icons accept size and className props.

/** Instagram — official camera icon with proper gradient support */
...
/** Facebook — official 'f' logo path, renders in currentColor */
...
/** WhatsApp — official brand icon path */
...
/**
 * Google Maps pin icon — use for "Get Directions" links.
 * Renders in currentColor (match your link colour).
 */
export function GoogleMapsIcon({ size = 20, className = "" }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
